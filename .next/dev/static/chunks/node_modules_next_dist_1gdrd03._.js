...
_export(exports, {
    ...
    markErrorAsAlreadyLoggedOnServer: function markErrorAsAlreadyLoggedOnServer1() {
        return markErrorAsAlreadyLoggedOnServer;
    },
    patchConsoleMethod: function patchConsoleMethod1() {
        return patchConsoleMethod;
    },
    wasErrorAlreadyLoggedOnServer: function wasErrorAlreadyLoggedOnServer1() {
        return wasErrorAlreadyLoggedOnServer;
    }
});
var UNDEFINED_MARKER = '__next_tagged_undefined';
var alreadyLoggedOnServerSymbol = Symbol('nextAlreadyLoggedOnServer');
...
function wasErrorAlreadyLoggedOnServer(value) {
    return (typeof value === "undefined" ? "undefined" : _type_of._(value)) === 'object' && value !== null && value[alreadyLoggedOnServerSymbol] === true;
}
...
var shouldForwardLogs = isTerminalLoggingEnabled || !!("TURBOPACK compile-time value", true);
var methods = [
    'log',
    'info',
    'warn',
...
var flushBufferedEntries = function flushBufferedEntries(socket) {
...
function getServerError(error, type) {
    ...
    var errorCode = error.__NEXT_ERROR_CODE;
